...
{
    public partial class frmCargaManual : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                String hdfOtTemportal = Guid.NewGuid().ToString();
                txtOT.Text = hdfOtTemportal;
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Guid gLote = Guid.Parse(txtOT.Text);
                oPaqueteCN.FnCargarManualDatosTablaTemporal(gLote, intIdServicio, intIdUsuario, intIdCliente, strDetalleDeOrdenServicio, intIdOficina, strIdProvinciaCarga, strIdCantonCarga, intIdContrato);
        ...
        protected void ASPxGridView1_RowValidating(object sender, DevExpress.Web.Data.ASPxDataValidationEventArgs e)
        {
            ...
            {
                AddError(e.Errors, ASPxGridView1.Columns["codigo"],
                "Código de envío no puede ser nulo.");
            }
        }
