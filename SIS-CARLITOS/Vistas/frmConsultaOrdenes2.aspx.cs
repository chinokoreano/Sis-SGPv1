...
{
    public partial class frmConsultaOrdenes2 : System.Web.UI.Page
    {
        ...
        private void FnImprimirGuias(int intId)
        {
            ...
            try
            {
                ...
                Response.Clear();
                Response.ContentType = mimeType;
                Response.AddHeader("content-disposition", "attachment; filename=" + strNmArchivo + fileNameExtension);
                Response.BinaryWrite(renderedBytes);
                Response.Flush();
                Response.End();
        ...
        protected void grvOrdenesServicio_CustomButtonCallback1(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            //try
            //{
                int intOrdenId = (int)grvOrdenesServicio.GetRowValues(e.VisibleIndex, "id");
