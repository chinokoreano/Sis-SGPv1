<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmErrorCarga.aspx.cs" Inherits="SIS_CARLITOS.frmErrorCarga" %>
                ...
                <div id="principal-form">
                    <div id="principal-form-content" style="padding-left: 30px; padding-right: 30px;">
                        ...
                        <div class="panel panel-danger">
                            <div class="panel-heading h4">Error de Carga</div>
